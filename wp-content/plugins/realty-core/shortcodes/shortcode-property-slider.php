												...
												<div class="content">
													...
													<?php if ( ! $property_search_form ) {  // Hide when showing search form ?>
														...
														<div class="excerpt description">
															<?php if ( $show_excerpt && $excerpt ) { the_excerpt();	} ?>

															<?php if ( $show_title ) { echo '<div class="' . $arrow_class . '"></div>'; } ?>
															...
															<?php if ( $current_item_post_type == 'property' ) { ?>
																...
																<div class="property-data">
																	<?php if ( $show_title ) { ?><div class="property-price"><?php echo tt_property_price(); ?></div><?php } ?>
																	<div class="property-details">
																		<?php if ( $show_size ) { ?><div><i class="icon-size"></i><?php echo $size . $size_unit; ?></div><?php } ?>
																		<?php if ( $show_bedrooms ) { ?><div><i class="icon-bedrooms"></i><?php echo $bedrooms . ' ' . _n( esc_html__( 'Bedroom', 'realty' ), esc_html__( 'Bedrooms', 'realty' ), $bedrooms, 'realty' ); ?></div><?php } ?>
																		<?php if ( $show_bathrooms ) { ?><div><i class="icon-bathrooms"></i><?php echo $bathrooms . ' ' . _n( esc_html__( 'Bathroom', 'realty' ), esc_html__( 'Bathrooms', 'realty' ), $bathrooms, 'realty' ); ?></div><?php } ?>
																	</div>
																</div>
